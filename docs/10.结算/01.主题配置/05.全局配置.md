...
```ts [更多配置项]
import type { IconProps } from "vitepress-theme-teek/lib/components/common/Icon/src/icon";
...
```ts [更多配置项]
import { Message } from "vitepress-theme-teek/lib/components/common/Message/src/message";
