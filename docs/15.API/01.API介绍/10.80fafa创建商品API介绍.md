...
请求的 URL：**http://127.0.0.1:5000/api/ProductApi/CreateProduct**
...
| price  | decimal  | 是       | 商品价格，对应页面 “价格” 输入框     | 需为数字格式（支持整数、小数，如 10 9.9）                     |
| class  | string   | 是       | 产品类型，对应页面 “产品类型” 下拉框 | 1 电子书 2 软件 3 视频 4 音频 5 图片 6 文档文件(只能输入数字) |
...
1.  在生成二维码图片后，新增代码读取图片文件并转换为 Base64 字符串
2.  在返回结果中新增 QRCodeBase64 字段，包含二维码图片的 Base64 编码
